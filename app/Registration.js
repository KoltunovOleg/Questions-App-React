...
* Сравнить пароль введенный в двух полях
*/
...
*Сохранить email & pass в localstorage
*/
...
/**
 * Processing of entered data in registration form fields
 * Обработка введенных данных в поля формы регистрации
 */
  handleSubmit(event) {
    ...
    let email= event.target.email.value,
        ...
        this.props.onchangeAccess(getdata, email);
